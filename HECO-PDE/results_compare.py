...
class PMODE_Results:
    ...
    def getData_obj(self, benchID, D):
        os.listdir()
        new_path_1 = os.path.relpath('PMODE/Results/F{}_{}D_obj.txt'.format(benchID, D), self.cur_path)   
        Data_obj = []
    ...
    def getData_vio(self, benchID, D):
        new_path_2 = os.path.relpath('PMODE/Results/F{}_{}D_vio.txt'.format(benchID, D), self.cur_path)   
        Data_vio = []
    ...
    def getData_c(self, benchID, D):
        new_path_3 = os.path.relpath('PMODE/Results/F{}_{}D_c.txt'.format(benchID, D), self.cur_path)   
        Data_c = []
